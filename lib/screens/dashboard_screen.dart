...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  void _showInvoiceOptions(InvoiceModel inv) {
    showModalBottomSheet(
      context: context,
      backgroundColor: AppColors.cardBg,
      shape: const RoundedRectangleBorder(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${inv.invoiceNumber}  ·  ₹${_fmt(inv.totalAmount)}',
                        style: const TextStyle(
                          fontSize: 12,
                          color: AppColors.textLight,
                        ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _statusColor(inv.paymentStatus).withOpacity(0.1),
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.w600,
                      color: _statusColor(inv.paymentStatus),
                    ),
                  ),
                ),
              ],
            ...
            _OptionTile(
              icon: Icons.edit_outlined,
              label: 'Edit Invoice',
              sub: 'Update customer name, date or notes',
              color: AppColors.primary,
              onTap: () {
                Navigator.pop(context);
                AppConstant.infoMessage('Edit coming soon', context);
              },
            ),
            _OptionTile(
              icon: Icons.receipt_long_outlined,
              label: 'View Details',
              sub: 'See full invoice with items & payments',
              color: AppColors.green,
              onTap: () {
                Navigator.pop(context);
